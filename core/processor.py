            ...
            if not best_left_cand and not best_right_cand:
                if len(unmatched) == 1:
                    ...
                    new_hands_data.append({
                        ...
                        "fingertip": unmatched[0]["fingertip"],
                        "fingertip_detected": unmatched[0]["fingertip_detected"],
                        "class": "hand"
                    })
                else:
                    ...
                    new_hands_data.append({
                        ...
                        "fingertip": unmatched[-1]["fingertip"],
                        "fingertip_detected": unmatched[-1]["fingertip_detected"],
                        "class": "hand"
                    })
            # Chỉ thiếu tay trái
